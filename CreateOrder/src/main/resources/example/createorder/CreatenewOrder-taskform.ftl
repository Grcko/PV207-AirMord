<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("CreateNewOrder");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid CreateNewOrder");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: CreateOrder.CreatenewOrder
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">CreateNewOrder</label>
                            		<div class="div_texbox">
                              		<input name="CreateNewOrder" type="text" class="textbox" id="CreateNewOrder" value="${CreateNewOrder}" />
                            		</div>
