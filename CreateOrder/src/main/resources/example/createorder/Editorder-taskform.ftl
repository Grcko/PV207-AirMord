<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("t_want_edit");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid t_want_edit");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: CreateOrder.Editorder
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">t_want_edit</label>
                            		<div class="div_checkbox">
                              		<input name="t_want_edit" type="checkbox" class="checkbox" id="t_want_edit" value="${t_want_edit}" />
                            		</div>
